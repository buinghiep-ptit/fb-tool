                ...
                <Table sx={{ minWidth: 650 }}>
                  ...
                  <TableBody>
                    ...
                    <TableRowForm
                      ...
                      field1Err={methods.formState.errors?.team1?.passAccuracy}
                      field1Msg={
                        methods.formState.errors?.team1?.passAccuracy?.message
                      }
                      field2="team2.passAccuracy"
                      field2Err={methods.formState.errors?.team2?.passAccuracy}
                      field2Msg={
                    ...
                    <TableRowForm
                      ...
                      field1Err={methods.formState.errors?.team1?.shotsOnTarget}
                      field1Msg={
                        methods.formState.errors?.team1?.shotsOnTarget?.message
                      }
                      field2="team2.shotsOnTarget"
                      field2Err={methods.formState.errors?.team2?.shotsOnTarget}
                      field2Msg={
                        methods.formState.errors?.team2?.shotsOnTarget?.message
                      }
                      methods={methods}
                      endAdornment=""
                    />
