...
import { getCoachDeatail } from 'app/apis/coachs/coachs.service'
...
export default function CoachDetail(props: Props) {
  ...
  const [coach, setPlayer] = useState<any>()
  ...
  //   defaultValues.phone = coach.mobilePhone || ''
  //   defaultValues.dateOfBirth = coach.dateOfBirth
  //   defaultValues.married = coach.maritalStatus
  //   defaultValues.citizenIdentification = coach.citizenIdCard || ''
  //   defaultValues.dateRange = coach.dateCitizenId
  //   defaultValues.passPortDateRange = coach.datePassport
  //   defaultValues.passPort = coach.passport
  //   defaultValues.expirationDate = coach.dateExpirePassport
  //   defaultValues.gatheringDay = coach.dateJoined
  //   defaultValues.team = coach.idTeam
  //   defaultValues.position = coach.mainPosition
  //   defaultValues.dominantFoot = coach.dominantFoot
  //   defaultValues.clothersNumber = coach.jerseyNo
  ...
  //   defaultValues.sizeClothers = coach.shirtSize || ''
  //   defaultValues.viewPosition = coach.priority
  //   defaultValues.countMatch = coach.matchPlayedNo || 0
  //   defaultValues.cleanMatch = coach.cleanSheetNo || 0
  //   defaultValues.goal = coach.goalFor || 0
  ...
  //   defaultValues.prioritize = coach.isDisplayHome === 0 ? false : true
  //   defaultValues.status = coach.status
  //   setPreviewImage(coach.imageUrl)
  //   methods.reset({ ...defaultValues })
  //   setIdTeam(coach.idTeam)
  //   setDisableViewPosition(coach.isDisplayHome === 0 ? true : false)
  //   setIdPosition(coach.mainPosition)
  // }
  ...
  const fetchCoachDetail = async () => {
    const res = await getCoachDeatail(params.id)
    setPlayer(res)
